...
mme_ue_s1ap_id_t emm_ctx_get_new_ue_id(const emm_data_context_t * const ctxt) __attribute__((nonnull));
...
void emm_ctx_clear_ue_nw_cap(emm_data_context_t * const ctxt) __attribute__ ((nonnull)) ;
void emm_ctx_set_ue_nw_cap(emm_data_context_t * const ctxt, const ue_network_capability_t * const ue_nw_cap_ie) __attribute__ ((nonnull)) ;
void emm_ctx_set_valid_ue_nw_cap(emm_data_context_t * const ctxt, const ue_network_capability_t * const ue_nw_cap_ie) __attribute__ ((nonnull)) ;

void emm_ctx_clear_ms_nw_cap(emm_data_context_t * const ctxt) __attribute__ ((nonnull)) ;
void emm_ctx_set_ms_nw_cap(emm_data_context_t * const ctxt, const ms_network_capability_t * const ms_nw_cap_ie);
void emm_ctx_set_valid_ms_nw_cap(emm_data_context_t * const ctxt, const ms_network_capability_t * const ms_nw_cap_ie);

void emm_ctx_clear_drx_parameter(emm_data_context_t * const ctxt) __attribute__ ((nonnull)) ;
void emm_ctx_set_drx_parameter(emm_data_context_t * const ctxt, drx_parameter_t *drx) __attribute__ ((nonnull)) ;
void emm_ctx_set_valid_drx_parameter(emm_data_context_t * const ctxt, drx_parameter_t *drx) __attribute__ ((nonnull)) ;
