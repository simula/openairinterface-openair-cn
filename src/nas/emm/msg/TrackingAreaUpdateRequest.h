...
typedef enum tracking_area_update_request_iei_tag {
  ...
  TRACKING_AREA_UPDATE_REQUEST_GPRS_CIPHERING_KEY_SEQUENCE_NUMBER_IEI             = C_CIPHERING_KEY_SEQUENCE_NUMBER_IEI,
  TRACKING_AREA_UPDATE_REQUEST_OLD_PTMSI_SIGNATURE_IEI                            = GMM_PTMSI_SIGNATURE_IEI,
  ...
  TRACKING_AREA_UPDATE_REQUEST_OLD_LOCATION_AREA_IDENTIFICATION_IEI               = C_LOCATION_AREA_IDENTIFICATION_IEI,
  TRACKING_AREA_UPDATE_REQUEST_TMSI_STATUS_IEI                                    = GMM_TMSI_STATUS_IEI,
  TRACKING_AREA_UPDATE_REQUEST_MOBILE_STATION_CLASSMARK_2_IEI                     = C_MOBILE_STATION_CLASSMARK_2_IEI,
