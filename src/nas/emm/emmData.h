...
typedef struct emm_data_s {
   ...
   * ------------
   */
  hash_table_ts_t    *ctx_coll_ue_id; // key is emm ue id, data is struct emm_context_s
...
struct emm_context_s *emm_data_context_get(
  emm_data_t *emm_data, const mme_ue_s1ap_id_t ueid) __attribute__ ((nonnull)) ;

struct emm_context_s *emm_data_context_get_by_imsi (
  emm_data_t * emm_data, imsi64_t imsi64) __attribute__ ((nonnull)) ;

struct emm_context_s *emm_data_context_get_by_guti(
  emm_data_t *emm_data, guti_t *guti) __attribute__ ((nonnull)) ;

struct emm_context_s *emm_data_context_remove(
  emm_data_t *_emm_data, struct emm_context_s *elm) __attribute__ ((nonnull)) ;

void emm_data_context_remove_mobile_ids(
  emm_data_t *_emm_data, struct emm_context_s *elm) __attribute__ ((nonnull)) ;

int  emm_data_context_add(emm_data_t *emm_data, struct emm_context_s *elm) __attribute__ ((nonnull)) ;
int emm_data_context_upsert_imsi (emm_data_t * emm_data, struct emm_context_s *elm) __attribute__((nonnull));
