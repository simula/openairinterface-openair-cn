...
int encode_eps_attach_type(eps_attach_type_t *epsattachtype, uint8_t iei, uint8_t *buffer, uint32_t len);

uint8_t encode_u8_eps_attach_type(eps_attach_type_t *epsattachtype);

int decode_eps_attach_type(eps_attach_type_t *epsattachtype, uint8_t iei, uint8_t *buffer, uint32_t len);
