...
#define SUPPORTED_CODEC_LIST_NUMBER_OF_SYSTEM_INDICATION 2 /*Taking consideration of GERAN and UTRAN*/
#define SUPPORTED_CODEC_LIST_MINIMUM_LENGTH 5
#define SUPPORTED_CODEC_LIST_MAXIMUM_LENGTH ((4 * SUPPORTED_CODEC_LIST_NUMBER_OF_SYSTEM_INDICATION) + 1)
