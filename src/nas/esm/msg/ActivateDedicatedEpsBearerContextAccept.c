...
int
decode_activate_dedicated_eps_bearer_context_accept (
  ...
  uint32_t len)
{
  ...
  while (len - decoded > 0) {
    ...
    case ACTIVATE_DEDICATED_EPS_BEARER_CONTEXT_ACCEPT_PROTOCOL_CONFIGURATION_OPTIONS_IEI:
      if ((decoded_result =
           decode_protocol_configuration_options_ie (&activate_dedicated_eps_bearer_context_accept->protocolconfigurationoptions,
...
int
encode_activate_dedicated_eps_bearer_context_accept (
  activate_dedicated_eps_bearer_context_accept_msg * activate_dedicated_eps_bearer_context_accept,
  uint8_t * buffer,
  uint32_t len)
{
  ...
  if ((activate_dedicated_eps_bearer_context_accept->presencemask & ACTIVATE_DEDICATED_EPS_BEARER_CONTEXT_ACCEPT_PROTOCOL_CONFIGURATION_OPTIONS_PRESENT)
    ...
    if ((encode_result =
      encode_protocol_configuration_options_ie (&activate_dedicated_eps_bearer_context_accept->protocolconfigurationoptions, true,
