  ...
  uint32_t len)
{
  ...
  while (len - decoded > 0) {
    ...
    case ACTIVATE_DEDICATED_EPS_BEARER_CONTEXT_REJECT_PROTOCOL_CONFIGURATION_OPTIONS_IEI:
      if ((decoded_result =
             decode_protocol_configuration_options_ie (&activate_dedicated_eps_bearer_context_reject->protocolconfigurationoptions,
...
int
encode_activate_dedicated_eps_bearer_context_reject (
  activate_dedicated_eps_bearer_context_reject_msg * activate_dedicated_eps_bearer_context_reject,
  uint8_t * buffer,
  uint32_t len)
{
  ...
  if ((encode_result = encode_esm_cause (&activate_dedicated_eps_bearer_context_reject->esmcause, 0, buffer + encoded, len - encoded)) < 0)     //Return in case of error
  ...
  if ((activate_dedicated_eps_bearer_context_reject->presencemask & ACTIVATE_DEDICATED_EPS_BEARER_CONTEXT_REJECT_PROTOCOL_CONFIGURATION_OPTIONS_PRESENT)
    ...
    if ((encode_result =
         encode_protocol_configuration_options_ie (&activate_dedicated_eps_bearer_context_reject->protocolconfigurationoptions,
