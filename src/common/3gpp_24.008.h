...
int encode_ciphering_key_sequence_number_ie(ciphering_key_sequence_number_t *cipheringkeysequencenumber, const bool iei_present, uint8_t *buffer, const uint32_t len);
int decode_ciphering_key_sequence_number_ie(ciphering_key_sequence_number_t *cipheringkeysequencenumber, const bool iei_present, uint8_t *buffer, const uint32_t len);
...
int encode_location_area_identification_ie(location_area_identification_t *locationareaidentification, const bool iei_present, uint8_t *buffer, const uint32_t len);
int decode_location_area_identification_ie(location_area_identification_t *locationareaidentification, const bool iei_present, uint8_t *buffer, const uint32_t len);
...
int encode_mobile_identity_ie(mobile_identity_t *mobileidentity, const bool iei_present, uint8_t *buffer, const uint32_t len);
int decode_mobile_identity_ie(mobile_identity_t *mobileidentity, const bool iei_present, uint8_t *buffer, const uint32_t len);
...
int encode_mobile_station_classmark_2_ie(mobile_station_classmark2_t *mobilestationclassmark2, const bool iei_present, uint8_t *buffer, const uint32_t len);
int decode_mobile_station_classmark_2_ie(mobile_station_classmark2_t *mobilestationclassmark2, const bool iei_present, uint8_t *buffer, const uint32_t len);
...
int encode_mobile_station_classmark_3_ie(mobile_station_classmark3_t *mobilestationclassmark3, const bool iei_present, uint8_t *buffer, const uint32_t len);
int decode_mobile_station_classmark_3_ie(mobile_station_classmark3_t *mobilestationclassmark3, const bool iei_present, uint8_t *buffer, const uint32_t len);
...
int encode_plmn_list_ie(plmn_list_t *plmnlist, const bool iei_present, uint8_t *buffer, const uint32_t len);
int decode_plmn_list_ie(plmn_list_t *plmnlist, const bool iei_present, uint8_t *buffer, const uint32_t len);
...
int encode_authentication_parameter_rand_ie(authentication_parameter_rand_t authenticationparameterrand, const bool iei_present, uint8_t *buffer, const uint32_t len);
int decode_authentication_parameter_rand_ie(authentication_parameter_rand_t * authenticationparameterrand, const bool iei_present, uint8_t *buffer, const uint32_t len);
...
int encode_authentication_parameter_autn_ie(authentication_parameter_autn_t authenticationparameterautn, const bool iei_present, uint8_t *buffer, const uint32_t len);
int decode_authentication_parameter_autn_ie(authentication_parameter_autn_t * authenticationparameterautn, const bool iei_present, uint8_t *buffer, const uint32_t len);
...
int encode_authentication_response_parameter_ie(authentication_response_parameter_t authenticationresponseparameter, const bool iei_present, uint8_t *buffer, const uint32_t len);
int decode_authentication_response_parameter_ie(authentication_response_parameter_t *authenticationresponseparameter, const bool iei_present, uint8_t *buffer, const uint32_t len);
...
int encode_authentication_failure_parameter_ie(authentication_failure_parameter_t authenticationfailureparameter, const bool iei_present, uint8_t *buffer, const uint32_t len);
int decode_authentication_failure_parameter_ie(authentication_failure_parameter_t * authenticationfailureparameter, const bool iei_present, uint8_t *buffer, const uint32_t len);
...
int encode_network_name_ie(network_name_t *networkname, const uint8_t iei, uint8_t *buffer, const uint32_t len);
int decode_network_name_ie(network_name_t *networkname, const uint8_t iei, uint8_t *buffer, const uint32_t len);
...
int encode_daylight_saving_time_ie(daylight_saving_time_t *daylightsavingtime, const bool iei_present, uint8_t *buffer, const uint32_t len);
int decode_daylight_saving_time_ie(daylight_saving_time_t *daylightsavingtime, const bool iei_present, uint8_t *buffer, const uint32_t len);
...
int encode_emergency_number_list_ie(emergency_number_list_t *emergencynumberlist, const bool iei_present, uint8_t *buffer, const uint32_t len);
int decode_emergency_number_list_ie(emergency_number_list_t *emergencynumberlist, const bool iei_present, uint8_t *buffer, const uint32_t len);
...
int encode_supported_codec_list(supported_codec_list_t *supportedcodeclist, const bool iei_present, uint8_t *buffer, const uint32_t len);
int decode_supported_codec_list(supported_codec_list_t *supportedcodeclist, const bool iei_present, uint8_t *buffer, const uint32_t len);
...
int encode_tmsi_status(tmsi_status_t *tmsistatus, const bool iei_present, uint8_t *buffer, const uint32_t len);
int decode_tmsi_status(tmsi_status_t *tmsistatus, const bool iei_present, uint8_t *buffer, const uint32_t len);
...
int encode_drx_parameter_ie(drx_parameter_t *drxparameter, const bool iei_present, uint8_t *buffer, const uint32_t len);
int decode_drx_parameter_ie(drx_parameter_t *drxparameter, const bool iei_present, uint8_t *buffer, const uint32_t len);
...
int encode_p_tmsi_signature_ie(p_tmsi_signature_t ptmsisignature, const bool iei_present, uint8_t *buffer, const uint32_t len);
int decode_p_tmsi_signature_ie(p_tmsi_signature_t *ptmsisignature, const bool iei_present, uint8_t *buffer, const uint32_t len);
...
int encode_identity_type_2_ie(identity_type2_t *identitytype2, bool is_ie_present, uint8_t *buffer, const uint32_t len);
int decode_identity_type_2_ie(identity_type2_t *identitytype2, bool is_ie_present, uint8_t *buffer, const uint32_t len);
...
int decode_ms_network_capability_ie(ms_network_capability_t *msnetworkcapability, const bool iei_present, uint8_t *buffer, const uint32_t len);
...
typedef struct routing_area_identification_s {
  location_area_identification_t lai;                      /*!< \brief  See 3GPP TS 23.003 4.2 Composition of the Routing Area Identification (RAI)    */
...
int encode_voice_domain_preference_and_ue_usage_setting(voice_domain_preference_and_ue_usage_setting_t *voicedomainpreferenceandueusagesetting,
    const bool iei_present, uint8_t *buffer, const uint32_t len);
int decode_voice_domain_preference_and_ue_usage_setting(voice_domain_preference_and_ue_usage_setting_t *voicedomainpreferenceandueusagesetting,
    const bool iei_present, uint8_t *buffer, const uint32_t len);
...
int encode_access_point_name_ie(access_point_name_t accesspointname, const bool iei_present, uint8_t *buffer, const uint32_t len);
int decode_access_point_name_ie(access_point_name_t *accesspointname, const bool iei_present, uint8_t *buffer, const uint32_t len);
...
int encode_quality_of_service_ie(quality_of_service_t *qualityofservice, const bool iei_present, uint8_t *buffer, const uint32_t len);
int decode_quality_of_service_ie(quality_of_service_t *qualityofservice, const bool iei_present, uint8_t *buffer, const uint32_t len);
...
int encode_linked_ti_ie(linked_ti_t *llcserviceaccesspointidentifier, const bool iei_present, uint8_t *buffer, const uint32_t len);
int decode_linked_ti_ie(linked_ti_t *llcserviceaccesspointidentifier, const bool iei_present, uint8_t *buffer, const uint32_t len);
...
int encode_llc_service_access_point_identifier_ie(llc_service_access_point_identifier_t *llcserviceaccesspointidentifier, const bool iei_present, uint8_t *buffer, const uint32_t len);
int decode_llc_service_access_point_identifier_ie(llc_service_access_point_identifier_t *llcserviceaccesspointidentifier, const bool iei_present, uint8_t *buffer, const uint32_t len);
...
int encode_gprs_timer_ie(gprs_timer_t *gprstimer, uint8_t iei, uint8_t *buffer, const uint32_t len);
