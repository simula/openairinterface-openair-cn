...
#define AVP_CODE_ULR_FLAGS                         (1405)
#define AVP_CODE_ULA_FLAGS                         (1406)
#define AVP_CODE_VISITED_PLMN_ID                   (1407)
#define AVP_CODE_REQUESTED_EUTRAN_AUTHENTICATION_INFO (1408)
#define AVP_CODE_NUMBER_OF_REQUESTED_VECTORS       (1410)
#define AVP_CODE_RE_SYNCHRONIZATION_INFO           (1411)
#define AVP_CODE_IMMEDIATE_RESPONSE_PREFERRED      (1412)
#define AVP_CODE_AUTHENTICATION_INFO               (1413)
#define AVP_CODE_E_UTRAN_VECTOR                    (1414)
#define AVP_CODE_UTRAN_VECTOR                      (1415)
#define AVP_CODE_GERAN_VECTOR                      (1416)
#define AVP_CODE_NETWORK_ACCESS_MODE               (1417)
#define AVP_CODE_HPLMN_ODB                         (1418)
#define AVP_CODE_ITEM_NUMBER                       (1419)
#define AVP_CODE_CANCELLATION_TYPE                 (1420)
#define AVP_CODE_DSR_FLAGS                         (1421)
#define AVP_CODE_DSA_FLAGS                         (1422)
#define AVP_CODE_CONTEXT_IDENTIFIER                (1423)
#define AVP_CODE_SUBSCRIBER_STATUS                 (1424)
#define AVP_CODE_OPERATOR_DETERMINED_BARRING       (1425)
...
#define AVP_CODE_STN_SR                            (1433)
#define AVP_CODE_ALERT_REASON                      (1434)
#define AVP_CODE_AMBR                              (1435)
#define AVP_CODE_CSG_SUBSCRIPTION_DATA             (1436)
#define AVP_CODE_CSG_ID                            (1437)
#define AVP_CODE_PDN_GW_ALLOCATION_TYPE            (1438)
#define AVP_CODE_EXPIRATION_DATE                   (1439)
#define AVP_CODE_RAT_FREQUENCY_SELECTION_PRIORITY_ID (1440)
#define AVP_CODE_IDA_FLAGS                         (1441)
#define AVP_CODE_PUA_FLAGS                         (1442)
#define AVP_CODE_NOR_FLAGS                         (1443)
#define AVP_CODE_USER_ID                           (1444)
#define AVP_CODE_EQUIPMENT_STATUS                  (1445)
...
#define AVP_CODE_TRACE_COLLECTION_ENTITY           (1452)
#define AVP_CODE_KC                                (1453)
#define AVP_CODE_SRES                              (1454)
#define AVP_CODE_PDN_TYPE                          (1456)
#define AVP_CODE_ROAMING_RESTRICTED_DUE_TO_UNSUPPORTED_FEATURE (1457)
#define AVP_CODE_SUBSCRIBED_PERIODIC_RAU_TAU_TIMER (1619)
#define AVP_CODE_PUR_FLAGS                         (1635)
#define AVP_CODE_Equivalent_PLMN_List              (1637)
#define AVP_CODE_CLR_FLAGS                         (1638)
#define AVP_CODE_UVR_FLAGS                         (1639)
#define AVP_CODE_UVA_FLAGS                         (1640)
#define AVP_CODE_TIME_ZONE                         (1642)
#define AVP_CODE_LOCAL_TIME_ZONE                   (1649)
#define AVP_CODE_DAYLIGHT_SAVING_TIME              (1650)
#define AVP_CODE_Reset_ID                          (1670)
#define AVP_CODE_ADJACENT_PLMNS                    (1672)
#define AVP_CODE_ADDITIONAL_CONTEXT_ID             (1683)
#define AVP_CODE_SUBSCRIPTION_SCEF_REALM           (1684)
#define AVP_CODE_SUBSCRIPTION_DATA_DELETION        (1685)
#define AVP_CODE_PREFERRED_DATA_MODE               (1686)
#define AVP_CODE_Emergency_Info                    (1687)
#define AVP_CODE_V2X_SUBSCRIPTION_DATA             (1688)
#define AVP_CODE_V2X_PERMISSION                    (1689)
