...
/* Bearer Context Modified grouped Information Element */
int gtpv2c_bearer_context_modified_ie_set (nw_gtpv2c_msg_handle_t * msg, const bearer_context_modified_t * bearer_context);
