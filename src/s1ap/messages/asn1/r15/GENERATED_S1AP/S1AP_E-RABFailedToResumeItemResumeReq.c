...
static asn_TYPE_member_t asn_MBR_S1AP_E_RABFailedToResumeItemResumeReq_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct S1AP_E_RABFailedToResumeItemResumeReq, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_S1AP_ProtocolExtensionContainer_6890P18,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static asn_SEQUENCE_specifics_t asn_SPC_S1AP_E_RABFailedToResumeItemResumeReq_specs_1 = {
