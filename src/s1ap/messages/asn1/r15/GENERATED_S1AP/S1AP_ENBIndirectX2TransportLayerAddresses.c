...
static asn_per_constraints_t asn_PER_type_S1AP_ENBIndirectX2TransportLayerAddresses_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 1,  1,  1,  2 }	/* (SIZE(1..2)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_S1AP_ENBIndirectX2TransportLayerAddresses_1[] = {
	{ ATF_POINTER, 0, 0,
...
static asn_SET_OF_specifics_t asn_SPC_S1AP_ENBIndirectX2TransportLayerAddresses_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_S1AP_ENBIndirectX2TransportLayerAddresses = {
	...
	sizeof(asn_DEF_S1AP_ENBIndirectX2TransportLayerAddresses_tags_1)
		/sizeof(asn_DEF_S1AP_ENBIndirectX2TransportLayerAddresses_tags_1[0]), /* 1 */
	{ 0, &asn_PER_type_S1AP_ENBIndirectX2TransportLayerAddresses_constr_1, SEQUENCE_OF_constraint },
