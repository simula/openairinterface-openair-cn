...
typedef S1AP_ProtocolIE_SingleContainer_6842P19_t	 S1AP_SONInformation_Extension_t;
...
ber_type_decoder_f S1AP_SONInformation_Extension_decode_ber;
der_type_encoder_f S1AP_SONInformation_Extension_encode_der;
xer_type_decoder_f S1AP_SONInformation_Extension_decode_xer;
xer_type_encoder_f S1AP_SONInformation_Extension_encode_xer;
per_type_decoder_f S1AP_SONInformation_Extension_decode_uper;
per_type_encoder_f S1AP_SONInformation_Extension_encode_uper;
