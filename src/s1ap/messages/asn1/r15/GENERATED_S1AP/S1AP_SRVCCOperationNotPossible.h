...
ber_type_decoder_f S1AP_SRVCCOperationNotPossible_decode_ber;
der_type_encoder_f S1AP_SRVCCOperationNotPossible_encode_der;
xer_type_decoder_f S1AP_SRVCCOperationNotPossible_decode_xer;
xer_type_encoder_f S1AP_SRVCCOperationNotPossible_encode_xer;
per_type_decoder_f S1AP_SRVCCOperationNotPossible_decode_uper;
per_type_encoder_f S1AP_SRVCCOperationNotPossible_encode_uper;
