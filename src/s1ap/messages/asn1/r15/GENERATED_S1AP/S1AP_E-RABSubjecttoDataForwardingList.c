...
/*
 * This type is implemented using S1AP_E_RAB_IE_ContainerList_1165P0,
 * so here we adjust the DEF accordingly.
 */
static asn_per_constraints_t asn_PER_type_S1AP_E_RABSubjecttoDataForwardingList_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_S1AP_E_RABSubjecttoDataForwardingList = {
	...
	sizeof(asn_DEF_S1AP_E_RABSubjecttoDataForwardingList_tags_1)
		/sizeof(asn_DEF_S1AP_E_RABSubjecttoDataForwardingList_tags_1[0]), /* 1 */
	{ 0, &asn_PER_type_S1AP_E_RABSubjecttoDataForwardingList_constr_1, S1AP_E_RABSubjecttoDataForwardingList_constraint },
