...
static asn_per_constraints_t asn_PER_type_S1AP_E_RABList_constr_1 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_S1AP_E_RABList_1[] = {
	{ ATF_POINTER, 0, 0,
		...
		0,
		&asn_DEF_S1AP_ProtocolIE_SingleContainer_6842P13,
		0,
		{ 0, 0, 0 },
...
asn_TYPE_descriptor_t asn_DEF_S1AP_E_RABList = {
	...
	sizeof(asn_DEF_S1AP_E_RABList_tags_1)
		/sizeof(asn_DEF_S1AP_E_RABList_tags_1[0]), /* 1 */
	{ 0, &asn_PER_type_S1AP_E_RABList_constr_1, SEQUENCE_OF_constraint },
